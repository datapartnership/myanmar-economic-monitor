...
class BlackMarbleProcessor:
    ...
    def process_file(self, h5_file):
        ...
        try:
            ...
            if data is None:
                print(
                    f"Could not find appropriate dataset in {base_name}, skipping file"
                )
                return None
...
def main():
    ...
    output_dir = (
        "../../../data/ntl/myanmar_nightlights_tif"  # Output directory for TIFs
    )
